...
if __name__ == "__main__":
    ...
    if opt.debug:
        ...
        wandb.init(
            project="Face_Swapping", name=nowname, config=opt, dir=logdir, resume=resume
        )
    print(config)
    ...
    #         # print(name)
    #         if 'diffusion_model' in name and any(train_name in name for train_name in Train_names):
